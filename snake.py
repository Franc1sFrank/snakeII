...
caption_width = 500  #canvas width
caption_height = 500 #canvas height
white_color = (255, 255, 255) # white rgb
black_color = (0, 0, 0)
game_title = 'snakeII'
cell = 10 # grids
snake_init_pos = [[250,250], [240,250], [230,250], [220,250]] # snake initial position
food_pos = [random.randrange(1, 50) * 10, random.randrange(1, 50) * 10] # food initial random position
head_pos = [250, 250]
